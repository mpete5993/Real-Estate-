            ...
            <div class="col-lg-8 col-md-12 col-sm-12">
                <div class="row">
                    <div class="col-lg-12" style="margin-top: 20px">
                        <p> {{$posts->count()}} result(s) for '<b> {{ request()->input('postsearch') }} </b>' </p>
                    </div>
                </div>
                <div class="row">
                    @if ($posts->count() > 0)
                        ...
                        @else
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="">
                                        <p>No results found for  '<b> {{ request()->input('postsearch') }} </b>' </p><br>
                                    </div>
                                    <div class="tags">
                                        <a href=" {{url('blog')}} " class="tags_links">Go to Blog</a>
                                    </div>
                                </div>
                            </div>
                    @endif
