    ...
    <div class="container">
        <div class="row" id="property-header">
            <div class="col-lg-6 col-md-6">
                <h5> {{$properties->count()}} result(s) for '<b> {{ request()->input('search') }} </b>'</h5>
            </div>
        </div>
        ...
        <div class="row">
            @if ($properties->count() > 0)
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="">
                            <p>No results found for  '<b> {{ request()->input('search') }} </b>' </p><br>
                        </div>
                        <div class="tags">
                            <a href=" {{url('properties')}} " class="tags_links">View all Properties</a>
                        </div>
                    </div>
                </div>
            @endif
